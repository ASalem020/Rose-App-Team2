...
>(({ className, ...props }, ref) => (
  <Input
    className={cn(
      'rounded-e-lg rounded-s-none border-s-0 transition-colors hover:border-s-0 group-hover:border-zinc-400 group-focus-within:group-hover:border-maroon-600 dark:group-hover:border-zinc-500 dark:group-focus-within:group-hover:border-softPink-400',
      className,
    )}
    {...props}
    ref={ref}
