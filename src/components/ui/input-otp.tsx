...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'relative me-2 flex h-10 w-10 items-center justify-center rounded-xl border bg-background text-sm transition-all dark:border-zinc-600 dark:bg-secondary dark:text-white',
        isActive &&
          'z-10 border-maroon-600 dark:border-softPink-400',
        isFirstEmpty &&
          !isActive &&
