        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="relative text-zinc-500 transition-colors hover:text-maroon-600 dark:text-zinc-400 dark:hover:text-softPink-300">
              ...
              <span className="absolute -right-2.5 -top-2.5 flex h-5 w-5 items-center justify-center rounded-full bg-red-600 text-sm font-bold text-white ring-2 ring-white">
                8
              </span>
            </button>
          ...
          <Link
            href="#"
            className="text-base font-medium capitalize text-zinc-600 hover:text-maroon-600 dark:text-zinc-400 dark:hover:text-softPink-300"
          >
            العربية
          </Link>
        </div>
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-center space-x-12 px-4 py-3">
          {NAV_LINKS.map(link => (
            <Link
              ...
              href={link.href}
              className={cn(
                'flex items-center space-x-2 text-sm capitalize transition-colors hover:text-softPink-200 dark:hover:text-maroon-700',
                link.active
                  ? 'font-bold'
