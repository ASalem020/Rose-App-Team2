...
export function CardDemo() {
 return (
    <section className="mx-auto w-full px-8 py-16">
        ...
        <div className="relative h-[440px] w-80 shrink-0 overflow-hidden rounded-2xl">
          ...
          <div className="absolute inset-0 flex items-end p-6 text-white">
            <div className="flex flex-col gap-3">
              ...
              <Button asChild className="w-fit hover:bg-white rounded-xl bg-white text-maroon-600">
                <Link href="/products">Shop Now <ArrowRight strokeWidth={3} /></Link> 
              </Button>
            </div>
          </div>
        </div>
