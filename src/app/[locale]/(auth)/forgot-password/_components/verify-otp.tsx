...
export default function VerifyOtp({
  ...
  return (
    <section className="mx-auto flex w-full max-w-xs flex-col items-center justify-center">
      {/* Header */}
      <div className="w-full">
        {/* Title */}
        <h1 className="text-2xl font-semibold">
          {t('pages.forgot-password.otp.title')}
        </h1>

        {/* Edit email button & description sends user to step 1 */}
        <div className="flex items-center gap-2">
          <p className="text-xs text-zinc-500">
            {t('pages.forgot-password.otp.description')}{' '}
          ...
          <button
            ...
            className={cn(
              'text-xs capitalize text-maroon-700 underline',
            )}
          >
      ...
      <div className="w-full">
        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="flex items-center justify-end gap-2">
              <p>
                {t('pages.forgot-password.otp.sendNewCode')}
              </p>
              <button
                type="button"
            ...
            >
              {isVerifying ? (
                ...
                t('pages.forgot-password.otp.verify')
              )}
            </Button>
          </form>
        </Form>
        ...
        <div className="flex items-center justify-center gap-1">
          ...
          <button className="text-maroon-700 dark:text-softPink-400">
            {t('pages.forgot-password.otp.contactUs')}
          </button>
        </div>
      </div>
    </section>
